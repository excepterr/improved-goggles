...
import { checkDependencyUpdates, checkForUpdates, logger } from '../utils.js';
...
╰──────────────────────────────────────────────────────────────────────────────╯\x1b[0m
`;
function printSupportGuidelines() {
    process.stdout.write(SUPPORT_GUIDELINES);
}
function printStartupBanner(version, isCluster) {
...
export { checkUpdates, printShutdownMessage, printStartupBanner, printSupportGuidelines };
